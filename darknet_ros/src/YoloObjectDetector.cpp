 ...
 *  This node can control the accelerate.
 */
    ...
    for (int i = 0; i < numClasses_; i++) {
      if (rosBoxCounter_[i] > 0) {
        ...
        for (int j = 0; j < rosBoxCounter_[i]; j++) {
          ...
          float a;
          float area;
          p=boundingBox.probability;
          a = (xmax-xmin)*(ymax-ymin);
          area=a/1000 ;
          std::cout<<"Area is "<<area<<std::endl;
          std::cout<<"Print the P is    "<<p<<std::endl;
          ...
          if (i == 0) {
            ...
            if (p>=0.5) {
              ...
              if (a>=17.25) {
                ...
                teleop_.linear.x = 0.1;
                vel_pub.publish(teleop_);
              }
              else {std::cout<<"Too far."<<std::endl;}
            }
            ...
            if (area>= 50 ) {
              teleop_.linear.x = 0.075;
              teleop_.angular.z =0.025;
              vel_pub.publish(teleop_);
            }
            else{
          ...
          std::cout<<"The Duckiebot's current speed is  "<<v<<std::endl;
